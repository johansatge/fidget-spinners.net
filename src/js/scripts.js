...
var _onSort = function() {
  ...
  var sortTypes = {
    brand        : _sortByBrand,
    price_asc    : _sortByPriceAsc,
    price_desc   : _sortByPriceDesc,
    name_az      : _sortByNameAZ,
    name_za      : _sortByNameZA,
    added_newest : _sortByAddedNewest,
    added_oldest : _sortByAddedOldest,
  }
